        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-surface border border-slate-200 dark:border-surfaceBorder shadow-md">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-6 border-b border-slate-100 dark:border-gray-800">
            ...
            <div className="flex items-center gap-3">
              <div className="text-xs font-mono text-emerald-800 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800/60 px-3 py-1 rounded-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            ...
            <div>
              <select
                ...
                className="w-full px-3 py-2.5 rounded-xl bg-slate-50 dark:bg-gray-950 border border-slate-200 dark:border-gray-800 text-xs text-slate-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
              >
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-surface border border-slate-200 dark:border-surfaceBorder shadow-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {FALLBACK_SDS.map((s) => (
                ...
                >
                  ...
                  <div className="text-[11px] font-mono text-slate-500 dark:text-gray-400">CAS: {s.cas} • {s.concentration}</div>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 mb-6 font-mono text-xs">
            ...
            >
              ...
              <div className="text-[11px] text-slate-600 dark:text-gray-400 font-sans">Parsed CAS: {selectedSds.cas}</div>
            </div>
            ...
            >
              ...
              <div className="text-[11px] text-slate-600 dark:text-gray-400 font-sans">IUPAC & CAS validated</div>
            </div>

            <div
              className={`p-3.5 rounded-2xl border transition-all ${
                agentStep >= 3 ? "bg-emerald-50/60 dark:bg-gray-900 border-emerald-500 text-emerald-900 dark:text-emerald-300" : "bg-slate-50 dark:bg-gray-950 border-slate-200 dark:border-gray-800 text-slate-400 dark:text-gray-600"
              }`}
            >
              <div className="flex items-center gap-1.5 font-bold mb-1">
              ...
              <div className="text-[11px] text-slate-600 dark:text-gray-400 font-sans">Annex XIV rules checked</div>
            </div>

            <div
              className={`p-3.5 rounded-2xl border transition-all ${
                agentStep >= 4 ? "bg-purple-50/60 dark:bg-gray-900 border-purple-500 text-purple-900 dark:text-purple-300" : "bg-slate-50 dark:bg-gray-950 border-slate-200 dark:border-gray-800 text-slate-400 dark:text-gray-600"
              }`}
            >
              <div className="flex items-center gap-1.5 font-bold mb-1">
              ...
              <div className="text-[11px] text-slate-600 dark:text-gray-400 font-sans">{selectedSds.status === "PASS" ? "Green Approved" : "Escalation Flagged"}</div>
            </div>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-50 dark:bg-gray-950 border border-slate-200 dark:border-gray-800 font-mono text-xs">
            ...
            <div className="text-[11px] text-slate-500 dark:text-gray-500">
              Hazard Declarations: <span className="text-slate-700 dark:text-gray-400 font-mono">{selectedSds.ghs}</span>
            </div>
          </div>
        </div>
      )}
      ...
      {activeDemo === "rheology" && (
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-surface border border-slate-200 dark:border-surfaceBorder shadow-md">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-6 border-b border-slate-100 dark:border-gray-800">
            ...
            <div className="text-xs font-mono text-purple-800 dark:text-purple-400 bg-purple-50 dark:bg-purple-950/60 border border-purple-200 dark:border-purple-800/60 px-3 py-1 rounded-xl">
          ...
          {/* Preset Selector */}
          <div className="mb-6">
            <div className="text-xs font-mono text-slate-500 dark:text-gray-400 mb-2 font-semibold">Select Polymer Tensile Test Specimen:</div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {RHEOLOGY_PRESETS.map((p) => (
                ...
                >
                  ...
                  <div className="text-[11px] font-mono text-slate-500 dark:text-gray-400">{p.family} • {p.strain.length} data points</div>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 font-mono text-xs">
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-gray-950 border border-slate-200 dark:border-gray-800">
              ...
              <div className="text-[10px] text-slate-400 dark:text-gray-500 mt-1 font-sans">Calculated between 0.05% and 0.25% strain</div>
            </div>

            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-gray-950 border border-slate-200 dark:border-gray-800">
              <div className="text-slate-500 dark:text-gray-400 text-[11px] mb-1">Tensile Strength (&sigma; max)</div>
              <div className="text-2xl font-bold text-emerald-700 dark:text-emerald-400">{analyzedInvariants.tensileStrength} MPa</div>
              <div className="text-[10px] text-slate-400 dark:text-gray-500 mt-1 font-sans">Peak yield stress before necking</div>
            </div>

            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-gray-950 border border-slate-200 dark:border-gray-800">
              <div className="text-slate-500 dark:text-gray-400 text-[11px] mb-1">Fracture Toughness</div>
              <div className="text-2xl font-bold text-purple-700 dark:text-purple-400">{analyzedInvariants.toughness} MJ/m³</div>
              <div className="text-[10px] text-slate-400 dark:text-gray-500 mt-1 font-sans">Composite Simpson's rule integral</div>
            </div>
          </div>

          <div className="p-4 rounded-2xl bg-slate-100 dark:bg-gray-900 border border-slate-200 dark:border-gray-800 font-mono text-xs flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="text-slate-700 dark:text-gray-400 text-xs font-sans">
              <span className="text-purple-700 dark:text-purple-400 font-semibold font-mono">Mathematical Verification:</span> ISO 527-1 / ISO 527-2 Compliant vector regression engine.
            </div>
            <button
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-surface border border-slate-200 dark:border-surfaceBorder shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-mono text-xs">
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-gray-950 border border-slate-200 dark:border-gray-800">
              ...
              <div className="text-lg font-bold text-blue-700 dark:text-blue-400">{lastLatency}</div>
              <div className="text-[10px] text-slate-400 dark:text-gray-500 mt-1 font-sans">Direct from Redis memory</div>
            </div>

            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-gray-950 border border-slate-200 dark:border-gray-800">
              <div className="text-slate-500 dark:text-gray-400 text-[11px] mb-1">Invocation Cost</div>
              <div className="text-lg font-bold text-emerald-700 dark:text-emerald-400">{lastCost}</div>
              <div className="text-[10px] text-slate-400 dark:text-gray-500 mt-1 font-sans">Department budget spared</div>
            </div>

            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-gray-950 border border-slate-200 dark:border-gray-800">
              <div className="text-slate-500 dark:text-gray-400 text-[11px] mb-1">Multi-Cloud Failover</div>
              <div className="text-lg font-bold text-purple-700 dark:text-purple-400">99.99% SLA</div>
              <div className="text-[10px] text-slate-400 dark:text-gray-500 mt-1 font-sans">Azure &rarr; AWS Bedrock fallback</div>
            </div>
          </div>
        </div>
      )}
